...
struct _isr_table_entry __sw_isr_table _sw_isr_table[91] = {
	...
	{(const void *)0x8004189, (ISR)0x8000e71}, /* 6 */
	{(const void *)0x8004187, (ISR)0x8000e71}, /* 7 */
	{(const void *)0x8004185, (ISR)0x8000e71}, /* 8 */
	{(const void *)0x8004183, (ISR)0x8000e71}, /* 9 */
	{(const void *)0x8004181, (ISR)0x8000e71}, /* 10 */
	...
	{(const void *)0x800417f, (ISR)0x8000e71}, /* 23 */
	...
	{(const void *)0x800417d, (ISR)0x8000e71}, /* 40 */
