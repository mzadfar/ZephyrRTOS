...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_POWER_SWITCH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32F4_NV_FLASH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F429ZI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F429ZI_STM32F429XX, 1);
